...
const EJIServicesMenu = ({ isOpen, onClose, onOpenTranslator, onOpenCurrencyConverter, onOpenGuide }) => {
  const { t } = useLanguage();
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-white shadow-2xl border-2 border-gray-200">
        <CardHeader className="text-center relative bg-white border-b border-gray-100">
          <Button 
            variant="ghost" 
            size="sm" 
            onClick={onClose}
          ...
          <div className="flex items-center justify-center space-x-3 mb-4">
            <div className="w-16 h-16 bg-gradient-to-br from-green-600 to-red-600 rounded-2xl flex items-center justify-center shadow-lg">
                ...
                >
                  ...
                  <CardContent className="p-6 bg-white">
                    <div className="flex items-start space-x-4">
                      <div className={`w-14 h-14 rounded-xl bg-gradient-to-r ${service.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
